				...
				<div style={containerStyle}>
					<div className="box-container1" style={boxStyle}>
						...
						<h3 style={{ ...textStyle, textAlign: 'justify' }}>
							...
							<br />
							Mi vocación por la cocina comenzó desde muy temprana edad cuando pasaba fines de semana enteros mirando programas como “El
							Gourmet”, “Todo Dulce”, los Petersens, escuchando a Osvaldo Gross, Ariel Rodriguez Palacios, quería aprender cada técnica,
							¡cada detalle y quería probar todos los sabores también!
							<br />
							En el año 2003 terminé el colegio y comencé inmediatamente a estudiar cocina en el Instituto Argentino de Gastronomía
							(IAG), donde egresé en el 2008 con dos hermosos honores: recibir mi título de la mano de Ariel Rodriguez Palacios y ser
							evaluado en gastronomía por Osvaldo Gross.
							<br />
							A partir de allí mi camino de aprendizaje nunca se detuvo, realicé cursos de macarons, chocolatería, diseño y armado de
							tortas y comencé a cocinar para amigos, para familiares hasta que en 2009 decidí crear mi propio negocio gastronómico:
							"Como en Casa Norte y Sur". <br />
							Crecí rodeado de grandes maestros y sabores, la cocina de mi abuela y mi madre han dejado huella en mi estilo gastronómico
							y eso mismo es lo que quiero transmitir a través de mis preparaciones, que lleves a tu mesa y a tu familia opciones dulces
							y saladas como las que comerías en tu casa.
							<br />
							Actualmente en “Como en Casa” ofrecemos una amplia variedad de tortas, cookies, macarons, sandwiches de miga (con opciones
							vegetarianas), comidas caseras para resolver el día a día, catering para eventos y muchos más.
							<br />
